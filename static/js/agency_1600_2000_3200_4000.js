...
var configuration = [
                      ...
                      { id: '.left_title', timeout: betaRandomInRange(firstpaint, tttext)  },
                      { id: '.right_title', timeout: betaRandomInRange(firstpaint, tttext)  },
                      { id: '.footer_left', timeout: betaRandomInRange(firstpaint, tttext)  },
                      { id: '.test', timeout: betaRandomInRange(firstpaint, tttext) },
                      { id: '.worklist', timeout: betaRandomInRange(firstpaint, tttext)  },
                      { id: '.about', timeout: tttext },
                      { id: '.text1', timeout: betaRandomInRange(tttext, ttimages) },
                      { id: '.text2', timeout: betaRandomInRange(tttext, ttimages) },
                      { id: '.text3', timeout: ttimages},
                      { id: '.img1', timeout: betaRandomInRange(ttimages, plt) },
                      { id: '.img2', timeout: betaRandomInRange(ttimages, plt) },
                      { id: '.img3', timeout: betaRandomInRange(ttimages, plt) },
                      { id: '.img4', timeout: betaRandomInRange(ttimages, plt) },
                      { id: '.img5', timeout: plt },
                      { id: '.img6', timeout: plt },
                    ];
